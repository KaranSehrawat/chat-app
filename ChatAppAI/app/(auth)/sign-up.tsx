      ...
      style={{flex:1}}>
        ...
        >
          <View style={{alignItems:"center", marginBottom:48}}>
            ...
            <Text style={{color:Colors.textPrimary, fontSize:28, fontWeight:"700"}}>Welcome</Text>
            <Text style={{color:Colors.textSecondary, fontSize:15, marginTop:6}}>Sign up to continue</Text>
            </View>
            {
              error && (
                <View
